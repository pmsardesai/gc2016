						...
						<div className="info">
							<table>
								...
								<tr>
									...
									<td className="event highlight">Musical Night with Sidhanath Buyao and Karaoke</td>
									<td className="event empty"></td>
									<td className="event empty"></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td className="event highlight">Konkani Natak</td>
									<td className="event empty"></td>
									<td className="event empty"></td>
								</tr>
								<tr>
									<td className="time">5:45 PM</td>
